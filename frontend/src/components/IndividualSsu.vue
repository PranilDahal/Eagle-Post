<template>
		<div class="post_style_A">
			...
			<div class="post_text_inside">
				...
				<a href="">
					<h5 class="post_heading golden_link" v-on:click="expandAndShrink">{{title}}</h5>
				</a>
				...
				<div class="date">
					<a href="" class="post_sub_details_links">
						<i class="fa fa-calendar"></i> {{ssu.datePosted}}</a>
					<!-- <a href="">
									<i class="fa fa-comments-o"></i> 05</a> -->
	...
	export default {
		...
		data: function(){
			return{
				...
				description: this.ssu.description,
				expand : false
			}
		},
